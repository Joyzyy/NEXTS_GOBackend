...
func Login() gin.HandlerFunc {
	return func(g *gin.Context) {
		...
		g.SetCookie("token", token, 60*60*24, "/", "next-chakra-backend.onrender.com", false, false)
		g.SetCookie("refreshToken", refreshToken, 60*60*24*7, "/", "next-chakra-backend.onrender.com", false, true)
		g.JSON(
			http.StatusOK,
			responses.UserResponse{
...
func Logout() gin.HandlerFunc {
	return func(g *gin.Context) {
		g.SetCookie("refreshToken", "", 0, "/", "next-chakra-backend.onrender.com", false, true)
		g.JSON(
			http.StatusOK,
			responses.UserResponse{
				Status:  http.StatusOK,
